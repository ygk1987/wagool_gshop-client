    ...
    mounted(){
      ...
      */
      ...
      removeTrademark(){
        ...
        // delete this.options.trademark //delete删除已有属性不会触发界面更新
        this.$delete(this.options, 'trademark'); //需要使用vue的语法才能实现界面更新
      ...
      removeCategory(){
        ...
        this.$router.replace(this.$route.path) //path中可能包含keyword, 去除query参数
      },
